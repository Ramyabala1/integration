...
public class OPBMR {
	...
	public String toString() {
		return "OPBMR [clinicalHistory=" + clinicalHistory + ", illnessSummary=" + illnessSummary
				...
				+ ", followUpDate=" + followUpDate + ", diagnosisDisplay=" + diagnosisDisplay + ", complaintDisplay="
				+ complaintDisplay + ", medicationDisplay=" + medicationDisplay + ", orgName=" + orgName
				+ ", consentID=" + consentID + ", serviceName=" + serviceName + ", reasonDescription="
				+ reasonDescription + ", createdDate=" + createdDate + ", visitType=" + visitType + ", addNote="
				+ addNote + ", category=" + category + ", treatmentDetails=" + treatmentDetails + ", patientID="
				+ patientID + ", docId=" + docId + ", orgId=" + orgId + "]";
	}
